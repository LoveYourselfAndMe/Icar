...
package com.cheyifu.icar.zxing.camera;
...
//	private static final int MAX_FRAME_HEIGHT = 450; // = 5/8 * 720
    ...
    public CameraManager(Context context) {
        ...
        int widthwsl = display.getWidth();
        int heightwsl = display.getHeight();
        Log.i("屏幕的宽==", String.valueOf(widthwsl));
        Log.i("屏幕的高==", String.valueOf(heightwsl));
        Point size = new Point();
        display.getSize(size);
        int width1 = size.x;
        int height1 = size.y;
        Log.i("屏幕的宽", String.valueOf(width1));
        Log.i("屏幕的高", String.valueOf(height1));

        MAX_FRAME_WIDTH = height1 * 5 / 8;
        MAX_FRAME_HEIGHT = width1 * 5 / 8;
    }
