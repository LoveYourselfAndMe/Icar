...
public class AdLoopView extends BaseLoopView {
	...
	protected void initRealView() {
		View view = null;
		setScrollDuration(2000);	// 设置页面切换时间
...
//		Drawable mBackground = new ColorDrawable(Color.DKGRAY);//设置下方指示条的颜色灰色
		Drawable mBackground = new ColorDrawable(Color.TRANSPARENT);//设置下方指示条的颜色透明
...
//		dotsViewParams.addRule(RelativeLayout.CENTER_VERTICAL, RelativeLayout.TRUE);//设置点的位置
//		dotsViewParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT, RelativeLayout.TRUE);
		dotsViewParams.addRule(RelativeLayout.CENTER_IN_PARENT, RelativeLayout.TRUE);
